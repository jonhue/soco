...
mod meta {
    ...
    use num::Float;
    use soco::algorithms::online::multi_dimensional::online_balanced_descent::meta::{obd, Options};
    ...
    fn _1() {
        ...
        let t_end = 5;
        let result = o.offline_stream(&obd, t_end, Options::euclidean_squared(1.)).unwrap();
        result
            .0
