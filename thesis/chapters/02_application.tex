...
\end{align*} where we assume that the energy supply is \textit{sufficient}\index{sufficient energy supply}, i.e. $p \leq \sum_{i \in I} p_{t,j}^{(i)}$.
