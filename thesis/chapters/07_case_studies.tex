...
\begin{figure}
    ...
    \resizebox{\textwidth}{!}{\input{figures/facebook_2009_0_histogram.tex}}
    \caption{2009-0}
    \end{subfigure}
    \begin{subfigure}[b]{.3\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/facebook_2009_1_histogram.tex}}
    \caption{2009-1}
    \end{subfigure}
    \begin{subfigure}[b]{.3\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/facebook_2010_histogram.tex}}
    \caption{2010}
    \end{subfigure}
...
\begin{figure}
    \begin{subfigure}[b]{.3\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/facebook_2009_0_valley_lengths.tex}}
    \caption{2009-0}
    \end{subfigure}
    \begin{subfigure}[b]{.3\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/facebook_2009_1_valley_lengths.tex}}
    \caption{2009-1}
    \end{subfigure}
    \begin{subfigure}[b]{.3\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/facebook_2010_valley_lengths.tex}}
    \caption{2010}
    \end{subfigure}
...
\begin{figure}
    \begin{subfigure}[b]{.3\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/los_alamos_mustang_histogram.tex}}
    \caption{LANL Mustang}\label{fig:los_alamos:histogram}
    \end{subfigure}
    \begin{subfigure}[b]{.3\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/microsoft_histogram}}
    \caption{Microsoft Fiddle}\label{fig:microsoft:histogram}
    \end{subfigure}
    \begin{subfigure}[b]{.3\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/alibaba_histogram}}
...
\paragraph{Fractional vs Integral Cost} For all traces, the ratio of the fractional and the integral costs is 1 for a precision of at least $10^{-3}$. This is not surprising due to the large number of servers that is used in each model.

\begin{figure}
    \begin{subfigure}[b]{.5\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/opt_vs_opts}}
    \caption{Ratio of static and dynamic optima}\label{fig:case_studies:ud:opt_vs_opts}
    \end{subfigure}
    \begin{subfigure}[b]{.5\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/opt_vs_opts_against_mean_cost_reduction}}
...
\begin{figure}
    \begin{subfigure}[b]{.5\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/ud_runtimes}}
    \end{subfigure}
    \begin{subfigure}[b]{.5\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/ud_runtimes_slow}}
    \end{subfigure}
...
\begin{figure}
    \begin{subfigure}[b]{.5\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/ud_normalized_cost}}
    \caption{Normalized cost}\label{fig:case_studies:ud:normalized_cost}
    \end{subfigure}
    \begin{subfigure}[b]{.5\linewidth}
    \resizebox{\textwidth}{!}{\input{figures/ud_cost_reduction}}
