...
\begin{figure}
    \begin{subfigure}[b]{.3\linewidth}
    \resizebox{\textwidth}{!}{\input{thesis/figures/facebook_2009_0_valley_lengths.tex}}
    \caption{2009-0}
    \end{subfigure}
    \begin{subfigure}[b]{.3\linewidth}
    \resizebox{\textwidth}{!}{\input{thesis/figures/facebook_2009_1_valley_lengths.tex}}
    \caption{2009-1}
    \end{subfigure}
    \begin{subfigure}[b]{.3\linewidth}
    \resizebox{\textwidth}{!}{\input{thesis/figures/facebook_2010_valley_lengths.tex}}
    \caption{2010}
    \end{subfigure}
